...
public class ApplicantReportFilter implements BasicValidation {
    private ArrayList<String> filteredFlatTypes = new ArrayList<>();
    private ArrayList<String> filteredProjectNames = new ArrayList<>();
    private int maxAge;
    private int minAge;
    private ArrayList<String> filteredMaritalStatus = new ArrayList<>();
    private Scanner sc = new Scanner(System.in);

    public ArrayList<String> getFilteredFlatTypes() { return filteredFlatTypes; }

    public ArrayList<String> getFilteredProjectNames() {
        return filteredProjectNames;
    }

    public ArrayList<String> getFilteredMaritalStatus() { return filteredMaritalStatus; }

    public int getMaxAge() { return maxAge; }
    public int getMinAge() { return minAge; }

    public void createFilter(ArrayList<HDBProject> projects) {
    ...
    public <T> void filterLists(ArrayList<T> masterList, ArrayList<T> addToList) {
        int choice;
        while (true) {
    ...
    public void filterFlatTypes(ArrayList<HDBProject> projects) {
        ArrayList<String> availableFlatTypes = new ArrayList<>();
    ...
    public void filterProjectNames(ArrayList<HDBProject> projects) {
    ...
    public void filterMaritalStatus() {
        ArrayList<String> maritalStatuses = new ArrayList<>();
